...
public class SystemUtil {
    ...
    public static final class OsInfo {
        ...
        // private final String FILE_ENCODING = LocaleUtils.getSystem().getCharset().name();
        private final String  FILE_ENCODING      = getSystemProperty("file.encoding", false);      ;
    ...
    private static void append(StringBuilder buffer, String caption, String value) {
        buffer.append(caption).append(defaultIfNull(value, "[n/a]")).append("\n");
    }

    private static String defaultIfNull(String value, String defaultStr) {
        if (value != null) {
            return value;
        }
        return defaultStr;
    ...
    public static void main(String[] args) {
        ...
        for (String key : list) {
            ...
            System.out.println(key + " = " + defaultIfNull(value, "[n/a]"));
        }
    }
}
