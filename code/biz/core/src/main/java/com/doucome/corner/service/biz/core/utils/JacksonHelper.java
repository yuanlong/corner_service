...
public class JacksonHelper {
    ...
    static{
      //add FAIL_ON_UNKNOWN_PROPERTIES to false, example CodeResult.isSuccess but not has set method
        ...
        toJSONMapper.configure(SerializationConfig.Feature.WRITE_NULL_PROPERTIES,false) ;
        toJSONMapper.configure(SerializationConfig.Feature.AUTO_DETECT_IS_GETTERS,false) ;
    }
