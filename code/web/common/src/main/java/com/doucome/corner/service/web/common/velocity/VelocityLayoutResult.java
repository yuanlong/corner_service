package com.doucome.corner.service.web.common.velocity;
...
public class VelocityLayoutResult extends VelocityResult {
	...
	private static final Log velocityLog = LogFactory.getLog("velocity-log") ;
	...
	public void doExecute(String finalLocation, ActionInvocation invocation)
		...
		try {
			...
			if(velocityLog.isDebugEnabled()){
				velocityLog.debug("contentType = " + contentType) ;
			}
